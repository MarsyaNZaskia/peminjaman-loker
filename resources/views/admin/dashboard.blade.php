...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="mb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-linear-to-br from-purple-50 to-purple-100 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-purple-200">
                <div class="flex items-center justify-between">
                    <div>
    ...
    <div class="mb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="bg-linear-to-br from-indigo-50 to-indigo-100 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-indigo-200">
                <div class="flex items-center justify-between">
                    <div>
