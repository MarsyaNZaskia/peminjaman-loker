        ...
        <form method="POST" action="{{ route('admin.users.store') }}">
            ...
            <div class="mb-4">
                ...
                <p class="text-xs text-gray-500 mt-1">
                    ⚠️ Password harus minimal 8 karakter, mengandung huruf besar, huruf kecil, angka, dan simbol (!@#$%^&*)
                </p>
                @error('password')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_confirmation" 
                       class="w-full px-3 py-2 border rounded-lg @error('password') border-red-500 @enderror" 
                       required>
                <p class="text-xs text-gray-500 mt-1">Ketik ulang password yang sama</p>
