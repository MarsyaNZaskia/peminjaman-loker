                ...
                <div class="md:col-span-8 p-8 flex flex-col">
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div class="flex gap-3 w-full sm:w-auto">
                                <a href="{{ route('admin.peminjaman.edit', $buku) }}" onclick="confirmBorrow()" class="flex-1 sm:flex-none text-center bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg shadow-lg shadow-blue-500/30 transition transform hover:-translate-y-0.5 text-sm font-semibold flex items-center justify-center">
